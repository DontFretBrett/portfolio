        ...
        <div className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed" itemProp="description">
          ...
          <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border-l-4 border-blue-500">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
                <span><strong>Production AI Systems Builder</strong> — J5 Agent Fleet (standalone agent operations platform), autonomous trading platform (J5-Trade) with 3 AI models and 12+ daemons, plus 24/7 AI assistant (Johnny5 on OpenClaw)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
