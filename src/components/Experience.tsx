  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-12 text-gray-800 dark:text-gray-100 transition-colors duration-200">Professional Experience</h2>
        
        <div className="space-y-12">
          {experiences.map((exp) => (
            <div key={exp.company} className="border-l-4 border-blue-600 dark:border-blue-400 pl-6 transition-colors duration-200">
              <div className="flex items-center gap-4 mb-4">
                <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 transition-colors duration-200">{exp.company}</h3>
                <span className="text-gray-500 dark:text-gray-400 flex items-center gap-1 whitespace-nowrap transition-colors duration-200">
                ...
                {exp.roles.map((role) => (
                  ...
                  >
                    <div className="flex items-center gap-4 mb-3">
                      <h4 className="text-xl font-medium text-gray-700 dark:text-gray-200 transition-colors duration-200" itemProp="roleName">
                        {role.title}
                      </h4>
                      {role.period && (
                        <span className="text-gray-500 dark:text-gray-400 flex items-center gap-1 whitespace-nowrap transition-colors duration-200">
                    ...
                    {role.description && (
                      <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-200" itemProp="description">
                        {role.description}
                      </p>
                    )}
