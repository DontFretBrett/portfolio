...
export default function BlogPost({ post }: BlogPostProps) {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8 dark:bg-gray-900 min-h-screen">
        ...
        {post.podcast && post.podcast !== 'PODCAST_URL_HERE' && (
          <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-xl border border-blue-200 dark:border-gray-600">
            ...
            >
              ...
              <source src={post.podcast} type="audio/wav" />
              <source src={post.podcast} type="audio/ogg" />
              Your browser does not support the audio element. 
              <a href={post.podcast} className="text-blue-600 dark:text-blue-400 hover:underline">
            ...
            <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">
              ...
              between two AI hosts about the leadership themes covered in this article.
            </div>
          </div>
        )}
      </header>
      ...
      {/* Article Content */}
      <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-strong:text-gray-900 dark:prose-strong:text-gray-100 prose-code:text-blue-600 dark:prose-code:text-blue-400 prose-pre:bg-white dark:prose-pre:bg-gray-800 prose-pre:border prose-pre:border-gray-200 dark:prose-pre:border-gray-700">
        <ReactMarkdown
