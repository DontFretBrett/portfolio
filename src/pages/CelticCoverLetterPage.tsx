...
export default function CelticCoverLetterPage() {
  return (
    <>
      <Helmet>
        <title>Cover Letter — Celtic Bank | Brett Sanders</title>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <article className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 px-10 py-12 text-slate-700 dark:text-slate-300">
            ...
            <header className="mb-10">
              <p className="text-base font-semibold text-slate-900 dark:text-slate-100">Brett Sanders</p>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                El Cajon, CA 92020 &nbsp;·&nbsp; 858-375-6634 &nbsp;·&nbsp;{' '}
                <a
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-4">March 31, 2026</p>
            ...
            {/* Salutation */}
            <p className="mb-6 text-sm leading-7">Dear Celtic Bank Hiring Team,</p>
            ...
            <div className="mt-10 text-sm">
              <p className="mb-6 leading-7">Sincerely,</p>
              <p className="font-semibold text-slate-900 dark:text-slate-100 text-base">Brett Sanders</p>
            </div>
          </article>
