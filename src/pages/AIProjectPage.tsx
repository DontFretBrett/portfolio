...
export default function AIProjectPage() {
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl dark:bg-gray-900 min-h-screen transition-colors duration-200">
        <Link 
          to="/ai-projects"
        ...
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-colors duration-200">
          <header className="p-4 md:p-8 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 transition-colors duration-200">
              {project.title}
            </h1>
            
            <div className="flex items-center text-gray-600 dark:text-gray-400 mb-4 transition-colors duration-200">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6 transition-colors duration-200">
              {project.description}
            </p>
            ...
            {project.tags && project.tags.length > 0 && (
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 transition-colors duration-200"
                  >
          ...
          {project.embedCode && (
            <section className="p-4 md:p-8 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6 transition-colors duration-200">Interactive Demo</h2>
              <div className="w-full bg-gray-50 dark:bg-gray-900 rounded-lg p-2 md:p-4 transition-colors duration-200">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-3 text-center transition-colors duration-200">
